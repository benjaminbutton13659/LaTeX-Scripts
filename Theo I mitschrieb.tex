...
\node at (0,-.4) {$x_1$};
\node at (1.8,-.4) {$x_2$};
\node at (6,1) {Stab der \underline{Eichlänge} $ l_0 = x_2' - x_1' $};
\end{tikzpicture}
...
\end{itemize} 
\subsubsection{Bsp: Myonenzerfall}
...
\underline{Nichtrelativistisch} beträgt die Flugzeit
$$t_{f} = \frac{9 \tx{ km}}{0.918 \ c} \approx 30 \mu \tx{s}$$
$$N(t_{f}) = 8 \cdot 10^7 e^{-\frac{30}{2.19}} \approx 90$$
\underline{Relativistisch über Zeitdilatation}
...
\underline{Relativistisch über Längenkontraktion}
